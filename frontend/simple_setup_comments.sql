...
DROP POLICY IF EXISTS "Users can view any task comment" ON task_comments;
...
DROP POLICY IF EXISTS "Users can view any comment reaction" ON comment_reactions;
DROP POLICY IF EXISTS "Users can insert their own reactions" ON comment_reactions;
