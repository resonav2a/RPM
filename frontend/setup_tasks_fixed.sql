...
-- This will create or update the tasks table with proper column naming
...
-- Drop existing tasks table if it exists (be careful with this in production!)
DROP TABLE IF EXISTS tasks CASCADE;

-- Create tasks table with consistent snake_case column names
